...
public class EndStep extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sp = PreferenceManager.getDefaultSharedPreferences(EndStep.this);
		String username = sp.getString("username", "");
		String id_attivita = sp.getString("id_attivita", "");

		if (!username.isEmpty() && !id_attivita.isEmpty()) {
			Intent i = new Intent(EndStep.this, WaitingTap.class);
			Log.d("value", "Home attività " + username + " con id_attivita = " + id_attivita + " avvenuto con successo!!");
			finish();
			startActivity(i);
			Toast.makeText(EndStep.this, "Buongiorno " + username + "!", Toast.LENGTH_LONG).show();
			return;
		}
